...
#set ylabel "DOS / PDOS (eV^{-1})" font ",22" offset 2.5,0
#
#set key top right opaque font ",17" box ls 101 width -0.5 height 1 maxcols 2 \
...
p F2P_0 u 1:($3+$6) w l ls 22 notitle 'Total Transmission: FE-AF',\
  F2P_1 u 1:($3+$6) w l ls 33 notitle 'Total Transmission: FE-FE',\
