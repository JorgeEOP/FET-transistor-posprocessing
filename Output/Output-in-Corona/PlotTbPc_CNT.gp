...
#Jorges_Farben.gp'
#
#set terminal pngcairo size 1024,768 enhanced font "Helvetica, 23" #Dissertation  
#
#set output '/Users/jorge_jaeger/Desktop/Physik/KIT/PhD/Dissertation/Bilder/\
#TbPc-9_0_CNT-Ohne_Metall-DZVP-SR/\
#TbPc-16_per-9_0_CNT_Ohne_Metall-1eVrange-DZVP-SR.png'
##set output '/Users/jorge_jaeger/Desktop/Physik/KIT/PhD/Dissertation/Bilder/\
##TbPc-9_0_CNT-Ohne_Metall-DZVP-SR/\
##TbPc-16_per-9_0_CNT_Ohne_Metall-1eVrange-DZVP-SR-CDFT-UP.png'
#
...
#
#F2P_0 = "< paste TbPc-9_0_CNT-Ohne_Metall-DZVP-SR/out-alpha.out \
#TbPc-9_0_CNT-Ohne_Metall-DZVP-SR/out-beta.out"
##F2P_0 = "< paste TbPc-FE-16_per-9_0_CNT_Ohne_Metall-DZVP-SR-CDFT-Mg6-C26-UP/\
##out-alpha-sp-g.out TbPc-FE-16_per-9_0_CNT_Ohne_Metall-DZVP-SR-CDFT-Mg6-C26-UP/\
##out-beta-sp-g.out"
#
...
#set ytics  @YTICSDOS out nomirror offset 0.4,0
#set mxtics 2
#set mytics 2
#
...
#set grid noytics
#
#set key box top right opaque font ",21" width 0 height 0.6 \
#                                 spacing 1.1 samplen 2
...
#
#{
#set ylabel "DOS (eV^{-1})" offset 1.4,0
#
...
#
#set label 1 "(a)" font ",26" at -0.49,47.0 left front
##set arrow 1 from fano_00,0 to fano_00,50 arrowstyle 777 front
##set arrow 2 from fano_01,0 to fano_01,50 arrowstyle 777 front
#
...
#set ytics  @YTICST
#set mxtics 2
#set xlabel "E + E_f (eV)" offset 0,0.7
#set ylabel "T (arb. units)" offset 0.3,0
#
### Moeglichkeiten fuer eines Bild ohne Titel
...
#unset arrow 1
#unset arrow 2
#set label 2 "(b)" font ",26" at -0.49,5.5 left front
##set arrow 1 from fano_00,0 to fano_00,6 arrowstyle 777 front
##set arrow 2 from fano_01,0 to fano_01,6 arrowstyle 777 front
#
#p F2P_0 u 1:3 w l ls 2 notitle ' ',\
#  F2P_0 u 1:6 w l ls 3 notitle ' ',\
#  F2P_0 u 1:($3+$6) w l ls 33 notitle ' ',
#
### Fuer CNT
...
##
##
################ (2) Summe von alpha+beta: transmission and DOS ################
...
#-up-down/out-sp-alpha-all.out \
#2-TbPc-Antipar-16_per-9_0_CNT_Al-1eVrange-DZVP-SR-CDFT-C26-C26-up-down/\
#out-sp-beta-all.out"
...
set tics font ",20" scale 1.0
set xrange @XRANGEDOS
set yrange @YRANGEDOS

set xtics @XTICSDOS out nomirror offset 0,0.4
set ytics @YTICSDOS out nomirror offset 0.4,0
set mxtics 2
set mytics 2
set format x ''

set ylabel 'DOS(eV^{-1})' font ",23"  offset 2,0

set key top right opaque box ls 101 width -1.5 height 0.6 \
                                   spacing 1.3 samplen 2 font ",19"
...
16per-TbPc2_CNT9_0_Metal-Antipar_FE-FE-SR-CDFT-SUM.png'
#set title "16 periods (9,0)CNT + 2TbPc_2: Comparison Antipar/FE-FE;\
...
F2P_2 = "CNTs/CNT9_0-14periods-DZVP-SR/out.dat"
...
p F2P_0 u 1:($2+$5) w filledcurves above y1=0 ls 22 fs transparent solid 0.2 \
                                                              title "FE-AF" ,\
  F2P_0 u 1:($2+$5) w l ls 22 notitle ' ',\
  F2P_1 u 1:($2+$5) w filledcurves above y1=0 ls 33 fs transparent solid 0.2 \
                                                              title "FE-FE" ,\
  F2P_1 u 1:($2+$5) w l ls 33 notitle ' ',\
  1/0 t "Bare (9, 0) CNT" ls 44
...
unset logscale y
set xlabel 'E-E_f (eV)' offset 0,1
set format x
#set format y "%3.0f"
set mxtics 2
set xlabel "E + E_f (eV)" font ",23" offset 0,0.9
set ylabel "T(E)"       font ",23" offset 1,0
...
p F2P_0 u 1:($3+$6)  w l ls 22 notitle ' ',\
  ...
  F2P_2 u ($1-0.08):3 w l ls 44 notitle ' '
...
#set mytics 2
#
#set xlabel "E + E_{f} (eV)"       font ",22" offset 0,0.7
#set ylabel "DOS / PDOS (eV^{-1})" font ",22" offset 1.5,0
#
#set key top right opaque font ",20" box ls 101 width -0.5 height 1 spacing 1.1 \
#                                                                     samplen 2
#
#set border ls 101
#set tics scale 1.2 
#
##set label 2 "(a)" font ",26" at -0.49,95 left front
##set label 2 "(b)" font ",26" at -0.49,95 left front
#
...
#
#{
#set output '2-TbPc-Antipar-16_per-9_0_CNT_Ohne_metall-DZVP-SR-CDFT-Mg6-C26-Mg6-\
#C26-up-down-DOS_PDOS.png'
#
...
#
#{
#set output '2-TbPc-FE-FE-16_per-9_0_CNT_Ohne_metall-DZVP-SR-CDFT-Mg6-C26-Mg6-\
#C26-UP-UP-DOS_PDOS.png'
#
...
#_Ohne_Metall-DZVP-SR-CDFT-Mg6-C26-Mg6-C26-UP-UP/out-beta-sp-ng-1eV-PDOS.out"
#
#p F2P_0 u 1:($2+$5) w filledcurves above y1=0 ls 33 fs transparent solid \
#                                                  0.15 title "Total DOS",\
#  F2P_0 u 1:($2+$5) w l ls 33 notitle ' ',\
#  F2P_1 u 1:3 w filledcurves above y1=0 ls 2 fs transparent solid 0.2 title \
#                                           "PDOS: 2-SMMs, {/Symbol a}-spin",\
#  F2P_1 u 1:3 w l ls 2 notitle ' ',\
#  F2P_1 u 1:7 w filledcurves above y1=0 ls 3 fs transparent solid 0.2 title \
...
#set terminal pngcairo size 1024,768 enhanced font 'Helvetica, 22'
#
#set output '2-TbPc-Antipar-FE-FE-16_per-9_0_CNT_Ohne_metall-1eVrange-DZVP-Mg6-\
#C26-up-down-UP-UP-Trans.png'
#
...
#set grid noxtics
#set grid noytics
#set xlabel "Energy (eV)"     font ",22" offset 0,0.7
#set ylabel "T (arb. units)"  font ",22" offset 1.5,0
#
#set key top left opaque font ",20" width 1 height 0.5 spacing 1.2 \
#                                                                   samplen 2
#set style textbox opaque noborder
#
##set grid ls 9
...
#set rmargin at screen 0.96
#
#p F2P_0 u 1:($3+$6) w l ls 22 title 'FE-AF',\
#  F2P_1 u 1:($3+$6) w l ls 33 title 'FE-FE',\
